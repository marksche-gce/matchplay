...
DROP POLICY IF EXISTS "Tenant organizers can update players registered in their tourna" ON public.players_new;
DROP POLICY IF EXISTS "Tenant organizers can update players registered in their tournaments" ON public.players_new;
...
CREATE POLICY "Tenant admins can update players"
